...
# --- 修改点1: 彻底简化 COUNTRY_FLAG_MAP 为直接的键值对 ---
COUNTRY_FLAG_MAP = {
    '阿拉伯联合酋长国': '🇦🇪',
    '阿根廷': '🇦🇷',
    '澳大利亚': '🇦🇺',
...
# --- 修改点2: 相应地简化 get_flag_emoji 函数 ---
def get_flag_emoji(country_name):
    """根据国家中文名返回对应的旗帜Emoji"""
    return COUNTRY_FLAG_MAP.get(country_name, '🌍') # 如果找不到，默认返回地球
...
def main():
    ...
    for line in content.splitlines():
        ...
        if match:
            try:
                ...
                proxy_name = f"{flag} {country} {server}"
    ...
    print(f"[+] Found and processed {len(proxies)} proxies.")
